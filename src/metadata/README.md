 ...
 * [distel.yml](distel.yml)
     * Determines how your purl.obolibrary.org/obo/distel/ redirects will be handled
     ...
     * Paste in the contents of [distel.yml](distel.yml)
 ...
 * [distel.md](distel.md)
     ...
     * Paste in the contents of [distel.md](distel.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
